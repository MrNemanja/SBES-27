This team project implements a Database Management Service that provides secure, role-based access to a text-file database of electricity consumption data. 
